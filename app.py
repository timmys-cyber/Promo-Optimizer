...
with st.container():
    with st.form("input_panel"):
        ...
        with col3:
            # ADDED TENNIS OPTION
            sport_cat = st.radio("Sport", ["All Sports", "NBA", "NFL", "NHL", "NCAAB", "Tennis"], horizontal=True)
        with col4:
...
if run_scan:
    ...
    if not api_key:
        ...
        # UPDATED SPORT MAP WITH ATP AUS OPEN
        sport_map = {
            "All Sports": ["basketball_nba", "americanfootball_nfl", "icehockey_nhl", "basketball_ncaab", "tennis_atp_aus_open"],
            "NBA": ["basketball_nba"], 
                    ...
                    if res.status_code == 200:
                        ...
                        for game in games:
                            ...
                            for s in source_odds:
                                # Logic for identifying the opponent team
                                ...
                                if profit > -5.0:
                                    all_opps.append({
                                        ...
                                        "sport": sport.replace('tennis_','').replace('basketball_','').replace('americanfootball_','').replace('icehockey_','').upper(),
